...
Public Class frmBrandList
    Dim _brandid, _brand, tmpid As String
    ...
    Sub LoadRecord()
        ...
        While dr.Read
            i += 1
            DataGridView1.Rows.Add(i, dr.Item("brandid").ToString, dr.Item("brand").ToString, "EDIT", "DELETE")
        End While
        dr.Close()
        cn.Close()
    ...
    Private Sub DataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        ElseIf colname = "Column5" Then
            If (MsgBox("Are you sure you want to delete this record", vbYesNo + vbQuestion) = vbYes) Then
                cn.Open()
                cm = New MySqlCommand("delete from tblbrand where brandid like'" & DataGridView1.Rows(e.RowIndex).Cells(1).Value.ToString & "'", cn)
                cm.ExecuteNonQuery()
    ...
    Private Sub DataGridView1_SelectionChanged(sender As Object, e As EventArgs) Handles DataGridView1.SelectionChanged
        ...
        _brandid = DataGridView1.Item(1, i).Value
        _brand = DataGridView1.Item(2, i).Value
    End Sub
End Class